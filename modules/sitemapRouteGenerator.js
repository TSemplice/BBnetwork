export default function () {
    this.nuxt.hook('generate:done', (context) => {
        const routesToExclude = ['/shop/all-products', '/en/shop/all-products', '/preview', '/en/preview'] // Add any route you don't want in your sitemap. Potentially get this from an .env file.
