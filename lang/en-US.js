export default {
  ...
  landlords: {
    ...
    p3: `Our staff aims to make the entire rental experience as easy as possible. We take care of the process from start to finish. You set the conditions of use and we find the students to suit your needs and property type.`,
    ...
    list2_p: `Student housing runs throughout the school year which means low season for property rentals is almost entirely covered, giving you a steady income throughout most of the year.`,
