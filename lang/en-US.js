export default {
  ...
  learn: `Learn more`,
  contact_us: `Contact us about student housing`,
  contact_us_2: 'Contact us to find you student housing',
  contact_us_3: 'Contact us about renting your propety',
  email_us: `Email us`,
  reach: 'ho to reach',
  contacts: {
    subtitle: 'contact us',
  ...
  home: {
    ...
    intro2: `BB Network, leaders in European student housing`,
    intro3: `throughout Europe for over twenty years. We provide `,
  ...
  aboutus: {
    ...
    cta2_q: `Are you a landlord?`,
    cta2_title: `Rent your property as student apartments in cities like Rome, Barcelona and more`,
  ...
  apartments: {
    intro: `BB Network has been providing quality student accommodation in Rome and Spain for decades. Our student housing is carefully chosen based on their location, comfortable and spacious bedrooms, bathrooms, kitchens and common areas. Our properties are located in Trastevere, a charming cobblestoned lined neighborhood known for its lively nightlife, as well as other popular Rome neighborhoods such as the elegant Prati, the historic center of Rome, St. Peter's district and the central residential area of San Giovanni.`,
  },
  university: {
    subtitle: 'FOR universities - University housing',
    intro: `Student apartments throughout Europe - all inclusive services.`,
    p1: `BB Network has been providing spacious and comfortable student housing for international university students for over 20 years. We offer full service contracts to accommodate both students and property owners. Our apartments are all centrally located in residential neighborhoods of European university cities such asRome, Barcelona and more. All apartments are within close proximity to university. Our mission is to deliver consistent customer service, bilingual assistance (English and Italian) and 24/7 emergency support.`,
    p2: ``,
    p3: ``,
    list_title: `What BB Network offers Universities?`,
  ...
  landlords: {
    subtitle: 'For Property Owner -  FOR universities - University housing',
    ...
    list2_title: `Trustworthy tenants`,
    list2_p: `We know how valuable your personal space is and entrusting us to find the right person to live in your home is something we take seriously. All students are vetted by the university so you can be sure your home is in safe hands.`,
    list3_title: `Low season rentals`,
    list3_p: `Our collaboration with universities allows us to ensure constant occupancy of your apartment throughout the year, even during low season. These relationships help us guarantee fixed and regular student housing rentals, giving you a steady income throughout the year.`,
  ...
  students: {
    ...
    intro: `International student housing Rome, Barcelona and more`,
    p1: `BB Network apartments are equipped with all amenities to make your stay a pleasant one. Apartments are centrally located and include comforts such as wifi, landline telephone to receive incoming international calls, tv, washing machine and more. Apartments include a fully equipped kitchen, spacious bedrooms with bed linens and weekly cleaning.`,
    p2: ``,
    p3: ``,
    list_title: `What BB Network offers students?`,
