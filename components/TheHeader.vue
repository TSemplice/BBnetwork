<template>
  <div class="sticky w-full z-40 top-0 left-0 transition-[top]" id="navbar">
    ...
    >
      <nuxt-link :to="localePath('/')" @click="toggleMenu" class="!bg-transparent">
        <img
      ...
      <div class="nav hidden xl:flex items-center gap-6 h-full">
        ...
        <nuxt-link class="!bg-white !text-black" to="/">IT</nuxt-link>
      </div>
    ...
    >
      <div
        class="flex flex-col h-full pt-10 justify-between"
      >
        ...
        <div class="flex flex-col gap-4 justify-between">
          ...
          <div class="w-full bg-white h-12 flex justify-end items-center container" @click="toggleMenu">
            <p>Close</p>
